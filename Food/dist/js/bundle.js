...
function cards() {
    ...
    (0,_services_services__WEBPACK_IMPORTED_MODULE_0__.getResoerses)('http://localhost:3000/menu')
        .then(data => {
...
/* harmony export */   "getResoerses": function() { return /* binding */ getResoerses; }
/* harmony export */ });
